/**
 * Notification email HTML template builder.
 * Generates branded KrewPact email HTML for all notification types.
 */
...
export function buildLeadAssigned(event: LeadAssignedEvent): EmailPayload[] {
  return [
    {
...
export function buildEstimateApproved(event: EstimateApprovedEvent): EmailPayload[] {
  return [
    {
...
export function buildContractSigned(event: ContractSignedEvent): EmailPayload[] {
...
export function buildTaskOverdue(event: TaskOverdueEvent): EmailPayload[] {
  return event.recipients.map((r) => ({
    to: r.email,
...
export function buildDailyLogSubmitted(event: DailyLogSubmittedEvent): EmailPayload[] {
  return [
    {
      to: event.pm_email,
...
export function buildPortalMessageReceived(event: PortalMessageReceivedEvent): EmailPayload[] {
  const preview =
...
export function buildSequenceTaskCreated(event: SequenceTaskCreatedEvent): EmailPayload[] {
  return [
    {
      to: event.assignee_email,
