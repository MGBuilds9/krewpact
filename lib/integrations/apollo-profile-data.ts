/**
 * MDM Apollo search profile definitions.
 * 12 research-backed profiles covering all active MDM divisions.
 *
 * Design principles:
...
import type { ApolloSearchProfile } from './apollo-profiles';
