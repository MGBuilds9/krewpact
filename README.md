...
| 13 | `KrewPact-Execution-Board.md` | 14-week delivery program with phase gates, team ownership matrix, risk register, release gates, acceptance metrics *(contains timelines)* | 16 KB |
...
6. **Execution Board** — Delivery sequence *(has timelines)*
...
| Feature PRD (§1 Scope) | ← | *(absorbed Blueprint-Gap-Matrix)* | Legacy → V2 expansion mapping |
