...
-- Add columns that may not exist if leads was created by 00003
...
ALTER TABLE leads ADD COLUMN IF NOT EXISTS nurture_status TEXT DEFAULT 'pool';
...
ALTER TABLE leads ADD COLUMN IF NOT EXISTS estimated_sqft INTEGER;
...
ALTER TABLE leads ADD COLUMN IF NOT EXISTS province TEXT DEFAULT 'Ontario';
...
ALTER TABLE leads ADD COLUMN IF NOT EXISTS qualified_by UUID REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE leads ADD COLUMN IF NOT EXISTS disqualified_reason TEXT;
ALTER TABLE leads ADD COLUMN IF NOT EXISTS current_sequence_id UUID;
ALTER TABLE leads ADD COLUMN IF NOT EXISTS sequence_step INTEGER DEFAULT 0;
ALTER TABLE leads ADD COLUMN IF NOT EXISTS last_automation_at TIMESTAMPTZ;
...
ALTER TABLE leads ADD COLUMN IF NOT EXISTS domain_hash TEXT GENERATED ALWAYS AS (MD5(LOWER(COALESCE(domain, '')))) STORED;
...
-- Add columns that may not exist if contacts was created by 00003
...
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS decision_maker BOOLEAN DEFAULT FALSE;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS preferred_channel TEXT DEFAULT 'email';
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS timezone TEXT DEFAULT 'America/Toronto';
