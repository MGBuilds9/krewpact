...
2. **Clerk DNS** — CNAME for `clerk.hub.mdmgroupinc.ca` → `frontend-api.clerk.accounts.dev` (or remove `NEXT_PUBLIC_CLERK_DOMAIN` from Vercel env vars)
