...
describe('Supabase Database Types', () => {
  it('exports Database type with public schema', () => {
    ...
    const allTables: (keyof Tables)[] = [
      'audit_logs', 'divisions', 'roles', 'user_divisions', 'user_roles', 'users',
      'accounts', 'contacts', 'leads', 'opportunities', 'activities', 'opportunity_stage_history',
      'estimates', 'estimate_lines', 'estimate_versions',
      'projects', 'project_members', 'milestones', 'tasks', 'task_comments', 'project_daily_logs',
      'expense_claims',
      'notifications', 'notification_preferences',
      'erp_sync_map', 'erp_sync_jobs', 'erp_sync_events', 'erp_sync_errors',
    ];
  ...
  it('contains all expected project tables', () => {
    const projectTables: (keyof Tables)[] = [
      ...
      'tasks', 'task_comments', 'project_daily_logs',
    ];
  ...
  it('contains notification tables', () => {
    const notifTables: (keyof Tables)[] = [
      'notifications', 'notification_preferences',
    ];
  ...
  it('exports all expected enums', () => {
    const enumKeys: (keyof Enums)[] = [
      'lead_stage', 'opportunity_stage', 'estimate_status', 'project_status',
      'task_status', 'expense_status', 'notification_channel', 'notification_state',
      'role_scope', 'sync_direction', 'sync_status', 'user_status', 'workflow_state',
    ];
