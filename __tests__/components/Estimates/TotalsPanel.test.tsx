...
describe('TotalsPanel', () => {
  it('formats currency as CAD', () => {
    render(<TotalsPanel subtotal={5000} taxAmount={650} total={5650} />);
  ...
  it('shows correct HST label', () => {
    render(<TotalsPanel subtotal={1000} taxAmount={130} total={1130} />);
    expect(screen.getByText(/HST 13%/)).toBeDefined();
  });

  it('handles zero values', () => {
    render(<TotalsPanel subtotal={0} taxAmount={0} total={0} />);
  ...
  it('handles large numbers', () => {
    render(<TotalsPanel subtotal={1234567.89} taxAmount={160493.83} total={1395061.72} />);
  ...
  it('displays subtotal, tax, and total labels', () => {
    render(<TotalsPanel subtotal={100} taxAmount={13} total={113} />);
