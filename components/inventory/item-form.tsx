...
type ItemFormRegister = ReturnType<typeof useForm<FormInput, unknown, CreateItem>>['register'];
type ItemSetValue = ReturnType<typeof useForm<FormInput, unknown, CreateItem>>['setValue'];
type ItemErrors = ReturnType<typeof useForm<FormInput, unknown, CreateItem>>['formState']['errors'];
...
function StockLevelsCard({ register }: { register: ItemFormRegister }) {
  return (
    <Card>
      <CardHeader>
...
export function ItemForm({ divisionId, onSubmit, isSubmitting }: ItemFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <BasicInfoCard register={register} setValue={setValue} errors={errors} />
      <StockLevelsCard register={register} />
