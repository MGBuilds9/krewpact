        ...
        <Card>
          <CardContent className="py-16 text-center">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Full document management with folder navigation, file upload, search, and preview will
              be available in the next phase. This includes Supabase storage integration and file
              sharing.
            </p>
          </CardContent>
        </Card>
