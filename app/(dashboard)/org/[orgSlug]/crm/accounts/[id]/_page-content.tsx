...
function ProjectsTab({ projectHistory }: ProjectsTabProps) {
  return (
    <Card>
      <CardHeader>
...
function ContactsTab({ contacts, accountId, orgPush }: ContactsTabProps) {
  return (
    <Card>
...
function OpportunitiesTab({ opps, orgPush }: OpportunitiesTabProps) {
  return (
    <Card>
