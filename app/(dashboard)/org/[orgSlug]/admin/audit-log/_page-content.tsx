...
export default function AuditLogPage() {
  ...
  const resetTo1 = (fn: (v: string) => void) => (v: string) => {
    fn(v);
    setPage(1);
  };
    ...
    <>
      <div className="space-y-6 p-6">
        ...
        <AuditFilterBar
          ...
          dateTo={dateTo}
          total={total}
          onEntityType={resetTo1(setEntityType)}
          onAction={resetTo1(setAction)}
          onUserSearch={resetTo1(setUserSearch)}
          onDateFrom={resetTo1(setDateFrom)}
          onDateTo={resetTo1(setDateTo)}
          onReset={() => {
            setEntityType('');
            setAction('');
            setUserSearch('');
