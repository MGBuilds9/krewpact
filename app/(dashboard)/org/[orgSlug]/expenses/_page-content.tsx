...
import { Calendar, DollarSign, Plus, Search, User } from 'lucide-react';
...
function ExpenseRow({ expense, onSubmit }: ExpenseRowProps) {
  return (
    <Card>
...
function ExpenseSummary({ totalAmount, approvedAmount, pendingCount }: ExpenseSummaryProps) {
  return (
