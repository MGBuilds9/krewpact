          ...
          {selectedInvoice && (
            <InvoiceSnapshotReviewForm
              defaultValues={{
                ...
                status: selectedInvoice.status as 'draft' | 'submitted' | 'paid' | 'overdue' | 'cancelled' | undefined,
                subtotal_amount: selectedInvoice.subtotal_amount != null ? String(selectedInvoice.subtotal_amount) : '',
                tax_amount: selectedInvoice.tax_amount != null ? String(selectedInvoice.tax_amount) : '',
                total_amount: selectedInvoice.total_amount != null ? String(selectedInvoice.total_amount) : '',
                amount_paid: selectedInvoice.amount_paid != null ? String(selectedInvoice.amount_paid) : '',
